...
import sty from "./PlasmicPlp.module.css"; // plasmic-import: Jmk80R8t4r16ek/css
...
import Frame20Icon from "./icons/PlasmicIcon__Frame20"; // plasmic-import: emtqyfARhBfP46k/icon
                                      ...
                                      try {
                                        return (
                                          ...
                                          currentItem.product.variants[0]
                                            .currencyCode +
                                          " " +
                                          currentItem.product.variants[0].price
                                        );
                                      } catch (e) {
                                        if (e instanceof TypeError) {
                                          return "MRP : ₹ 2 495.00";
