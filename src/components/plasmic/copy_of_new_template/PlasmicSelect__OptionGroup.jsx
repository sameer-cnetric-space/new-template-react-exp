...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 1P10ddf3d-m0sI/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Ox4yvk8zsFH52W/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__up2MV)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__yNp0)}
              />
            </React.Fragment>
          ),
