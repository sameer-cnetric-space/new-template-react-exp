...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 1dNB0d53gYBxGU/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: izf9GDeCX27CKiB/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: bPiQEL1DrsFbzIl/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__n01Vh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___3C0FH)}
                role={"img"}
              />
            ),
